...
export default class ViewSlider extends React.Component {
  ...
  onScroll = (event) => {
    ...
    if (scrollPositionX >= 0 && scrollPositionX <= parseInt(width - offset)) {
      ...
      this.setState({ activeDot: 20 })
    } else if (scrollPositionX >= ((width * 20) - offset) && scrollPositionX <= (width * 21) - offset) {
      this.setState({ activeDot: 21 })
    } else if (scrollPositionX >= ((width * 21) - offset) && scrollPositionX <= (width * 22) - offset) {
      this.setState({ activeDot: 22 })
    } else if (scrollPositionX >= ((width * 22) - offset) && scrollPositionX <= (width * 22) - offset) {
      this.setState({ activeDot: 23 })
    } else if (scrollPositionX >= ((width * 23) - offset) && scrollPositionX <= (width * 23) - offset) {
      this.setState({ activeDot: 24 })
    } else if (scrollPositionX >= ((width * 24) - offset) && scrollPositionX <= (width * 24) - offset) {
      this.setState({ activeDot: 25 })
    } else if (scrollPositionX >= ((width * 25) - offset) && scrollPositionX <= (width * 25) - offset) {
      this.setState({ activeDot: 26 })
    } else if (scrollPositionX >= ((width * 26) - offset) && scrollPositionX <= (width * 26) - offset) {
      this.setState({ activeDot: 27 })
    } else if (scrollPositionX >= ((width * 27) - offset) && scrollPositionX <= (width * 27) - offset) {
      this.setState({ activeDot: 28 })
    } else if (scrollPositionX >= ((width * 28) - offset) && scrollPositionX <= (width * 28) - offset) {
      this.setState({ activeDot: 29 })
    } else if (scrollPositionX >= ((width * 29) - offset) && scrollPositionX <= (width * 29) - offset) {
      this.setState({ activeDot: 30 })
    }
  }
